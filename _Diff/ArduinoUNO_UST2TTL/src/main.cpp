...
/* Эта вся ерунда не нужна - берешь ЕСПшку:
1) земля на ресет
2) >Тх - Тх ПИ, >Ях - Ях ПИ
3) 115200 Putty
4) reboot Pi
...
SoftwareSerial softSerial(13,15);                                      // Создаём объект softSerial указывая выводы RX, TX (можно указывать любые выводы Arduino UNO)
